...
Initially, the execution of the function fn should be delayed by
 t milliseconds.

If, before the delay of t milliseconds, the function cancelFn 
...
The cancellation was scheduled to occur after a delay of cancelTimeMs
 (50ms), which happened after the execution of fn(2) at 20ms.
*/

var cancellable = function(fn, args, t) {
    let timeout = setTimeout(() => fn.apply(null, args), t);
